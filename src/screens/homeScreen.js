...
const HomeScreen = () => {
  const {addTask, deleteTask, updateTask, editThatTask, task, tasks, showAdd, updateAdd, editTask} =
    useTask();
      ...
      {showAdd && (
        ...
        <View>
          ...
          <TouchableOpacity
              ...
              onPress={() => {updateTask(taskId); setShowEditButton(false)}}>
              <AntDesing
                name="upload"
                color={'#D2ECFD'}
                size={25}
            ...
            <TouchableOpacity
              ...
              onPress={() => {addTask(taskId); setShowAddButton(false)}}>
              <AntDesing
                name="switcher"
                color={'#D2ECFD'}
                size={25}
      ...
      <View>
        <FlatList
          ...
          renderItem={({item, index}) => (
            ...
            onPressEdit={() => {editThatTask(item, index);
              settaskId(index);
